...
E3_VALUES = np.array([1.0, 2.2, 4.7])

# E6 values (20% tolerance)
E6_VALUES = np.array([1.0, 1.5, 2.2, 3.3, 4.7, 6.8])

# E12 values (10% tolerance)
E12_VALUES = np.array([1.0, 1.2, 1.5, 1.8, 2.2, 2.7,
                      3.3, 3.9, 4.7, 5.6, 6.8, 8.2])

# E24 values (5% tolerance)
E24_VALUES = np.array([1.0, 1.1, 1.2, 1.3, 1.5, 1.6, 1.8, 2.0, 2.2, 2.4, 2.7, 3.0,
                       3.3, 3.6, 3.9, 4.3, 4.7, 5.1, 5.6, 6.2, 6.8, 7.5, 8.2, 9.1])

# E48 values (2% tolerance)
E48_VALUES = np.array([1.00, 1.05, 1.10, 1.15, 1.21, 1.27, 1.33, 1.40, 1.47, 1.54,
...
E96_VALUES = np.array([1.00, 1.02, 1.05, 1.07, 1.10, 1.13, 1.15, 1.18, 1.21, 1.24,
...
E192_VALUES = np.array([1.00, 1.01, 1.02, 1.04, 1.05, 1.06, 1.07, 1.09, 1.10, 1.11,
