...
For $\vhd \lesssim 0.04\, n\VT$ ($\sim$\SI{1}{\milli\volt} for $n \approx 1$, $\sim$\SI{2}{\milli\volt} for $n \approx 1.85$), HD2 stays below \SI{1}{\percent} and only the leading term of \eqref{eq:power-series} survives:
\begin{equation}
\id \approx \gd \vd.
\label{eq:linear}
\end{equation}
