...
\end{equation}
These no longer collapse to energy conservation. They produce the parametric-upconversion result $|P_o|/|P_s| = \omega_o/\omega_s$ with $\omega_o = \omega_p + \omega_s$, the excess power supplied by the pump --- conversion gain above unity in principle, limited in practice by loss, matching, stability, and pump power.
