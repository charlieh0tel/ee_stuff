...
\end{equation}
the lower of the forward-crossing limit \eqref{eq:varactor-swing-limit} and the breakdown limit. Driving the junction into avalanche injects resistive dissipation that nullifies the Manley--Rowe advantage.
