...
The regime boundaries in junction voltage do not move---they depend only on $n$ and $\VT$---but smaller signals now produce a measurable output, improving sensitivity at the cost of a bias circuit and quiescent current drain.
