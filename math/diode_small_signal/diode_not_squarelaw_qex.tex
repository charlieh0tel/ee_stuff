...
\begin{equation}
  ...
  \label{eq:hd}
\end{equation}
These ratios define quantitative boundaries between operating regimes. HD2 reaches \SI{1}{\percent} at $\vhd \approx 0.04\,n\VT$ and \SI{25}{\percent} at $\vhd \approx n\VT$; HD3 reaches \SI{4}{\percent} at $\vhd \approx n\VT$. The \SI{1}{\percent} and \SI{25}{\percent} thresholds are useful engineering markers---not physical phase transitions---but they define a well-motivated window of just over a decade within which the two-term approximation is a fair description.
...
For a Ge or Schottky diode biased at $\IQ \approx \SI{100}{\micro\ampere}$, this range spans roughly \SI{1}{\milli\volt} to \SI{27}{\milli\volt} of junction amplitude (Table~\ref{tab:diode-numbers})---just over a decade.
...
The exponential is the truth; the square law is a convenience that holds across just over a decade of junction-voltage amplitude---between \SI{1}{\percent} and \SI{25}{\percent} second-harmonic distortion.
