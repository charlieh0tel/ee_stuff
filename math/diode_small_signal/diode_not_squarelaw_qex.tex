...
The two-term approximation \eqref{eq:quadratic} is valid, though least accurate at the upper edge, where the dropped cubic term adds \SI{12}{\percent} to the fundamental and the predicted rectified DC runs \SI{6}{\percent} low.
