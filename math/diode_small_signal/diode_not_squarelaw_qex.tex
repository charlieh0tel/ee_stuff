...
Biasing at a small forward current $\IQ$ raises the conductance $\gd = \IQ/(n\VT)$ and the responsivity $\gd/(2n\VT)$, so a given junction swing produces more rectified output.
The square-law boundaries ($0.04\,n\VT$ and $n\VT$) do not move---they depend only on $n$ and $\VT$---but smaller signals now produce measurable output, at the cost of a bias circuit and quiescent drain.
