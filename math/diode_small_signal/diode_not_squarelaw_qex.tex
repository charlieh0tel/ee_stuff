...
Two observations stand out. First, the Si p--n device has roughly $1.7$--$1.8\times$ the square-law amplitude headroom of Ge or Schottky, because its higher ideality factor raises $n\VT$; a 1N4148 can tolerate a junction swing up to $\sim$\SI{48}{\milli\volt} before HD2 exceeds \SI{25}{\percent}, versus $\sim$\SI{27}{\milli\volt} for a 1N34A.
...
An unbiased Si p--n junction, with $\IS$ in the nanoamp range or below, has almost no conductance and is essentially deaf without roughly half a volt of bias.
