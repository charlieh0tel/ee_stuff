...
For a Ge or Schottky diode biased at $\IQ \approx \SI{100}{\micro\ampere}$, this range spans roughly \SI{1}{\milli\volt} to \SI{27}{\milli\volt} of junction amplitude (Table~\ref{tab:diode-numbers})---about one decade.
...
The exponential is the truth; the square law is a convenience that holds over roughly one decade of junction-voltage amplitude---between \SI{1}{\percent} and \SI{25}{\percent} second-harmonic distortion.
