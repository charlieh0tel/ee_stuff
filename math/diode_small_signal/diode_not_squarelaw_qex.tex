...
The boundaries in Table~\ref{tab:diode-regimes} are algebraic. Table~\ref{tab:diode-numbers} instantiates them for three common technologies at $T = \SI{300}{\kelvin}$ and $\IQ \approx \SI{100}{\micro\ampere}$, using parameters extracted from the vendor datasheets \cite{nxp1n4148,skyworks1n5711,1n34a}.
