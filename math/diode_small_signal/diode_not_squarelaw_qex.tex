...
The lower ideality factor also nudges the square-law threshold $0.04\,n\VT$ down ($\sim$\SI{1.1}{\milli\volt} versus $\sim$\SI{1.9}{\milli\volt} for the Si p--n), but zero-bias operation is the decisive advantage.
