...
if __name__ == "__main__":
    ...
    slope_robust, intercept_robust, r_value_robust, p_value_robust, stderr_robust = (
        robust_linregress(x, y)
    )
    ...
    plt.plot(
        x, slope_ols * x + intercept_ols, color="red", label="Ordinary Least Squares"
    )
    plt.plot(
        x,
        slope_robust * x + intercept_robust,
        color="green",
        label="Robust Regression (HuberT)",
    )
    plt.xlabel("x")
    plt.ylabel("y")
    ...
    (
        slope_origin_ols,
        intercept_origin_ols,
        r_value_origin_ols,
        p_value_origin_ols,
        stderr_origin_ols,
    ) = ols_linregress(x, y, force_origin=True)
    ...
    (
        slope_origin_robust,
        intercept_origin_robust,
        r_value_origin_robust,
        p_value_origin_robust,
        stderr_origin_robust,
    ) = robust_linregress(x, y, force_origin=True)
    ...
    plt.plot(
        x,
        slope_origin_ols * x + intercept_origin_ols,
        color="blue",
        label="OLS Through Origin",
    )
    plt.plot(
        x,
        slope_origin_robust * x + intercept_origin_robust,
        color="purple",
        label="Robust Through Origin",
    )
    plt.xlabel("x")
    plt.ylabel("y")
